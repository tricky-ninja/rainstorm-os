/**
 *  Module: Global Descriptor Table (GDT)
 *
 *  Sets up segmentation for 32-bit protected mode.
 *
 *  Provides:
 *      - Kernel code segment
 *      - Kernel data segment
 *
 *  Must be initialized before loading IDT or enabling interrupts.
